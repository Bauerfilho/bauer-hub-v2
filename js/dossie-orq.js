/* F-H · Dossiê Orquestrador — os esqueminhas de preferência da casa.
   Conteúdo clínico ditado pela casa em 28/08/2026 (transcrição fiel; confirmações
   ...
   pela casa apesar de ausente na lista) | 'nao' (rede/compra).
   O dossiê é utilidade de vida médica — nunca pendência ou cobrança na tela da casa. */
window.DOSSIE_Orquestrador = {
  ...
  esqueminhas: [
    {tema:'Dor', itens:[
      ...
      {t:'Dor inflamatória / muscular', d:'Beta-Long (betametasona 3+3 inj) — a preferida da casa. Dexametasona injetável (preferência do Orquestrador) também disponível.', unidade:'sim'}
    ]},
    {tema:'Insônia', itens:[
    ...
    {tema:'Hipertensão — a escada do Orquestrador', itens:[
      {t:'1º', d:'Losartana.', unidade:'sim'},
      {t:'2º', d:'Anlodipino 1×/dia; depois sobe para 1-0-1.', unidade:'sim'},
      {t:'3º', d:'Hidroclorotiazida em dose baixa — máx. 25 mg NAS RECEITAS DA CASA (regra da casa; a HCTZ pode espoliar potássio).', unidade:'sim'},
    ...
    {tema:'Diabetes', itens:[
      {t:'1ª droga da casa', d:'Metformina, até 3×/dia (850 mg na unidade). Nota do Orquestrador: as diretrizes internacionais atuais já permitem abrir com drogas melhores (as "canetinhas" GLP-1 e os inibidores de SGLT2); ', unidade:'sim'},
      ...
      {t:'Titulação da semaglutida (esquema da casa)', d:'4 semanas com 0,25 mg → 4 semanas com 0,5 mg → RETORNO para avaliação médica → só então subir (ou não) para 1 mg.', unidade:'nao'},
    ...
    {tema:'Náusea', itens:[
      {t:'Ondansetrona — o melhor da casa para vômitos', d:'Na unidade: 4 mg orodispersível E 8 mg cp. Adulto pode dobrar a de 4 (2 cp sublinguais) se o enjoo for intenso.', unidade:'sim'}
    ]},
    ...
    {tema:'ITU (mulheres)', itens:[
      {t:'Escolha da casa', d:'Nitrofurantoína.', unidade:'nao'},
      {t:'Má adesão', d:'Fosfomicina (Monuril) dose única.', unidade:'nao'}
    ]},
    {tema:'Candidíase', itens:[
      {t:'Tópico', d:'Creme vaginal 1×/noite por 7 dias (na lista: miconazol 2%). Obs. do Orquestrador: uso relatado de metronidazol — o gel vaginal da lista é classicamente para vaginose; as duas opções valem.', unidade:'sim'},
      {t:'Oral', d:'Fluconazol 150 mg dose única.', unidade:'sim'},
      {t:'Combinada', d:'Creme + oral — opção registrada (aprovado na casa).', unidade:'sim'}
    ]},
    {tema:'Tremor', itens:[
      {t:'Propranolol', d:'Antes, afastar abstinência.', unidade:'sim'}
    ]},
    {tema:'Pele', itens:[
      {t:'Suspeita fúngica', d:'Miconazol creme (uso frequente) + creme de hidrocortisona + anti-inflamatório oral (registro do Orquestrador: "acho") + controle álgico sempre.', unidade:'sim'},
