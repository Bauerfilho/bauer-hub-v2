# Receituário de controle especial (PDF-12)

- **Título impresso no formulário:** RECEITUÁRIO CONTROLE ESPECIAL
- **Formato original:** folha paisagem com 2 vias lado a lado (2-up nativo)
...
## IDENTIFICAÇÃO DO COMPRADOR (preenchido na farmácia)
- NOME · I.D. · RG EMISSOR · CIDADE · UF · TELEFONE

## IDENTIFICAÇÃO DO FORNECEDOR (preenchimento físico na farmácia)
- ASSINATURA DO FARMACÊUTICO · DATA
- A área do fornecedor fica **vazia** na impressão — é preenchida fisicamente.
